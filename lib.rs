...
mod clinical_trial_data {
    ...
    pub struct ClinicalTrialData {
        ...
        data_summary: Mapping<String, u64>, // {'Treatment Positive': 3, 'Treatment Negative': 385, 'Placebo Positive': 28, 'Placebo Negative': 358}
